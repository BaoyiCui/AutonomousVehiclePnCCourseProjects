#include "carla_shenlan_stanley_pid_controller/vehicle_longitudinal_controller_pid.h"
...
static const rclcpp::Logger LOGGER = rclcpp::get_logger("carla_shenlan_stanley_pid_controller_publisher");


VehicleControlPublisher::VehicleControlPublisher()
    : Node("carla_shenlan_stanley_pid_controller")
/*'''**************************************************************************************
- FunctionName: None
- Function    : None
- Inputs      : None
...
**************************************************************************************'''*/
{
    ...
    pid_controller_longitudinal = std::make_unique<shenlan::control::PIDController>(0.16, 0.02, 0.01);
    ...
    // 读取参考线路径
    std::ifstream infile("src/ros-bridge/carla_shenlan_projects/carla_shenlan_stanley_pid_controller/data/2022_09_29_16_27_08_ins_data_map_after_preprocess.csv", ios::in);    //将文件流对象与文件连接起来
